...
const VehicleConfigurationContainer = () => {
  return (
    <div className="w-[592px] flex flex-col items-start justify-start gap-[24px] text-left text-lg text-colors-primary-white font-typography-button-large">
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[12px]">
        ...
        <div className="self-stretch rounded-3xs bg-color-cards h-[74px] flex flex-col py-0 px-3 box-border items-start justify-center">
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[12px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <div className="self-stretch rounded-3xs bg-color-cards flex flex-col items-center justify-start">
            <div className="self-stretch flex flex-row p-4 items-start justify-start gap-[28px] border-b-[1px] border-solid border-colors-secondary-grey-3 sm:flex-col">
              <div className="flex-1 flex flex-row items-center justify-start gap-[12px] sm:flex-[unset] sm:self-stretch">
                <img
              ...
              <div className="flex-1 relative text-right text-sm sm:flex-[unset] sm:self-stretch">
                <span className="leading-[22px]">Starts at</span>
                <b className="text-lg leading-[26px]"> ₹9 00 000.00*</b>
              </div>
            </div>
            <div className="self-stretch flex flex-row py-4 pr-4 pl-11 items-start justify-start gap-[10px] text-base sm:flex-col">
              <b className="flex-1 relative leading-[24px] sm:flex-[unset] sm:self-stretch">
                Key Features
              </b>
              <div className="flex-1 relative text-[inherit] leading-[24px] font-inherit sm:flex-[unset] sm:self-stretch">
          ...
          <div className="self-stretch rounded-3xs bg-color-cards flex flex-col items-center justify-start">
            <div className="flex flex-row p-4 items-start justify-between border-b-[1px] border-solid border-colors-secondary-grey-3 sm:flex-col">
            ...
            <div className="w-[592px] flex flex-row py-4 pr-4 pl-11 box-border items-start justify-start gap-[10px] text-base sm:flex-col">
              <b className="flex-1 relative leading-[24px] sm:flex-[unset] sm:self-stretch">
                Key Features
              </b>
              <div className="flex-1 relative text-[inherit] leading-[24px] font-inherit sm:flex-[unset] sm:self-stretch">
